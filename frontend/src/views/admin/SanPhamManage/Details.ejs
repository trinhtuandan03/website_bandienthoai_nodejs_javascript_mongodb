                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Thông Tin Chi Tiết Sản
                                            Phẩm</li>
                                    </ol>
                                </nav>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <dl class="row">
                                    ...
                                    <dd class="col-sm-9">@Html.DisplayFor(model => model.TieuDeSanpham)</dd>

                                    <!-- Mô Tả -->
                                    <dt class="col-sm-3">Mô Tả:</dt>
                                    <dd class="col-sm-9">@Html.DisplayFor(model => model.MoTaSanpham)</dd>
                                </dl>
                            </div>

                            <!-- Nút Thao Tác -->
                            <div class="card-footer text-right">
                                <a asp-action="Edit" asp-route-id="@Model.IdSanpham" class="btn btn-primary">Sửa Sản
                                    Phẩm</a>
